...
* @Project : niis 
* @Package : org.nii.niis.listSearch.web
* @FileName : AirLibListSearchController.java 
* @Date : 2017. 09. 12.
* @description : 웜본DB 목록 항공사진(해방전후) controller 객체
* </pre>
*/
@Controller
@RequestMapping(value="/airLibListSearch/")
public class AirLibListSearchController {
	...
	* @Method : listSearch
	* @Date : 2017. 09. 12.
	* @description : 웜본DB 목록 항공사진(해방전후) 페이지 진입
	* </pre>
	* @param param
	* @param request
	* @param response
	...
	*/
    ...
    public String listSearch(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		return "listSearch/airLibListSearch";
	}
	...
	* @Method : getYearList
	* @Date : 2017. 09. 12.
	* @description : 웜본DB 목록 항공사진(해방전후) 사업년도 조회
	* </pre>
	* @param param
	* @param request
	* @param response
	...
	*/
	...
	public ModelAndView getYearList(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/************************************** queryID 필수 **************************************/ 
		String queryId = SqlidConst.AIRLIB_LISTSEARCH_CODE_YEAR;
		/************************************** queryID 필수 **************************************/
	...
	* @Date : 2017. 09. 12.
	* @description : 웜본DB 목록 항공사진(해방전후) 사업지구 조회
	* </pre>
	* @param param
	* @param request
	* @param response
	...
	*/
	...
	public ModelAndView getZoneCodeList(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/************************************** queryID 필수 **************************************/ 
		String queryId = SqlidConst.AIRLIB_LISTSEARCH_CODE_ZONECODE;
		/************************************** queryID 필수 **************************************/
	...
	* @Date : 2017. 09. 12.
	* @description : 웜본DB 목록 항공사진(해방전후) 코스번호 조회
	* </pre>
	* @param param
	* @param request
	* @param response
	...
	*/
	...
	public ModelAndView getPhCourseList(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/************************************** queryID 필수 **************************************/ 
		String queryId = SqlidConst.AIRLIB_LISTSEARCH_CODE_PHCOURSE;
		/************************************** queryID 필수 **************************************/
	...
	* @Method : getPhNumList
	* @Date : 2017. 09. 12.
	* @description : 웜본DB 목록 항공사진(해방전후) 사진번호 조회
	* </pre>
	* @param param
	* @param request
	* @param response
	...
	*/
	...
	public ModelAndView getPhNumList(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/************************************** queryID 필수 **************************************/ 
		String queryId = SqlidConst.AIRLIB_LISTSEARCH_CODE_PHNUM;
		/************************************** queryID 필수 **************************************/
	...
	*/
	...
	public ModelAndView getResolutionList(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/************************************** queryID 필수 **************************************/ 
		String queryId = SqlidConst.AIRLIB_LISTSEARCH_CODE_RESOLUTION;
		/************************************** queryID 필수 **************************************/
	...
	* @Date : 2017. 09. 12.
	* @description : 웜본DB 목록 항공사진(해방전후) 목록 조회
	* </pre>
	* @param param
	* @param request
	* @param response
	...
	*/
	...
	public ModelAndView getAirProductList(@RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try{
			String action = "/airLibListSearch/getAirLibProductList.do";
			...
			//공급 수정
			modelAndView.addObject("imageCde", propertiesService.getString("Globals.airLibZoneCode"));
			modelAndView.addObject("RETURN_CD", jsonMap.get("RETURN_CD"));
		}catch(Exception e){
	...
	* @Date : 2017. 09. 12.
	* @description : 웜본DB 목록 항공사진(해방전후) 상세 조회
	* </pre>
	* @param model
	* @param param
	* @param request
	...
	*/
	...
	public String airListSrchDetail(Model model, @RequestParam Map<String, Object> param, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try{
			String action = "/airLibListSearch/getAirLibProductSubList.do";
