...
$(document).ready(function(){
	...
	$('.checkbox').each(function(){
		...
		$this.siblings('.labelTxt').click(function(){
			if ($(this).siblings('.checkbox').find(':checkbox').is(':checked')){
				$(this).siblings('.checkbox').removeClass('active').find(':checkbox').prop('checked',false);
			} else {
				$(this).siblings('.checkbox').addClass('active').find(':checkbox').prop('checked',true);
			}
		}).mouseenter(function(){
...
$(function(){
	...
	$(".dateSearch").datepicker({
		...
		yearRange: '2013:2018',
		showOn: "button",
		buttonImage: "../images/board/btn_datepicker_2.png",
		buttonImageOnly: true,
		buttonText: "선택",
		inline: true,
		duration: 300,
