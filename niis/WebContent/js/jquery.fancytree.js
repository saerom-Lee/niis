...
//				alert("remove child markup for " + node);
	...
	nodeRenderTitle: function(ctx, title) {
		 ...
		 */
			...
			//ares.push("<span class='fancytree-nocheck'><img src=\"/niis/images/icon/unchecked.png\" /></span>");
			ares.push("<span class='fancytree-nocheck'></span>");
		}
...
// Append a counter badge
		if( (count || ! extOpts.hideZeros) && (!node.isExpanded() || !extOpts.hideExpanded) ){
			$("span.fancytree-title", node.span).append("("+count+")");
		}
	},
