		...
		<div class="content">
			<div class="course course1">
				...
				<div class="list_01">
					...
					<div class="form" style="width:350px; height:150px;">
						<form action="./createSecureSession_1_1_response.jsp" method="post" name="popForm">
							...
							<input type="button" value="보안 세션 요청(로그인)" style="margin-left:30px; height:30px; width:200px;" onclick="Login(this,popForm, false);"></input>
						</form>
					</div>
				</div>
			</div>
