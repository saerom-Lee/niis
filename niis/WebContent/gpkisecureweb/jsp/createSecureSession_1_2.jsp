			...
			<div class="course course1">
				...
				<div class="list_01">
					...
					<div class="form_01" style="width:350px; height:100px;">
						...
						<a href="./createSecureSession_1_1_response.jsp?param1=123&param2=345&challenge=<%=challenge%>" id="linktest"></a>
						<input type="button" onclick="LoginLink(linktest);" value="보안 세션 요청(로그인)"/>
