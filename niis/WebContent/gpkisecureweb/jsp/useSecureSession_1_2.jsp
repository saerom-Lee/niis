			...
			<div class="course course1">
				...
				<div class="list_01">
					...
					<div class="form_01">
						...
						<a href="./createSecureSession_1_1_response.jsp?param1=123&param2=354345" id="encrypt_link"> </a>
						<input type="button" value="보안 세션 암호화" onClick="EncryptLink(encrypt_link, null, '<%=sessionid%>');"/>
