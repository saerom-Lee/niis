...
var ServerAddr     = "10.98.25.47:8080";
...
var gpkiScriptBase   = '/niis/gpkisecureweb/client';     		// * 스크립트에서 사용하는 클라이언트 모듈의 기본 경로 (var.js의 경로)
var clientModulePath = gpkiScriptBase + '/setup';			// * 클라이언트 설치 파일의 게시 경로. (cab, exe, dmg, rpm, deb)
var ServiceStartPageURL = '/niis/gpkisecureweb/index.html';		// * 설치완료후 이동할 페이지
var clientInstallPath = '/niis/gpkisecureweb/install.html';  	// * 설치 페이지 경로 
...
var clientVersion     = '1.1.2.7';				// * 클라이언트 버전. 버전 정보는 ','로 자리 구분. ( 21.09.15 1.1.2.6_ver 클라이언트 변경  )
...
document.write("<link rel='shortcut icon' href='" + "/niis/" + gpkiScriptBase + "/image/install/favicon.ico'	type='image/x-icon' />");
