...
if (fileID.equals("111")) {
    sysFileName = "2015 INNORIX Solution Brochure(r2).pdf"; // 시스템 저장 파일명
    orgFileName = "2015 이노릭스 솔루션 통합 소개자료(r2).pdf"; // 원본 파일명
}

if (fileID.equals("222")) {
    sysFileName = "2015 INNORIX Solution Brochure(r2).pdf";
    orgFileName = "2015 INNORIX Solution Brochure(r2).pdf";
}

if (fileID.equals("333")) {
    sysFileName = "2015 INNORIX Solution Brochure(r2).pdf";
    orgFileName = "2015 INNORIX ソリューションパンフレット(r2).pdf";
}
