...
<script type="text/javascript">
	...
	function getYearList(){
		ajaxCallJson("/airLibListSearch/getYearList.do", "", function(result, data){
	...
	function getZoneCodeList(){
		...
		ajaxCallJson("/airLibListSearch/getZoneCodeList.do", data, function(result, data){
	...
	function getPhCourseList(){
		...
		ajaxCallJson("/airLibListSearch/getPhCourseList.do", data, function(result, data){
	...
	function getPhNumList(){
		...
		ajaxCallJson("/airLibListSearch/getPhNumList.do", data, function(result, data){
	...
	function getCameraCodeList(){
		ajaxCallJson("/airLibListSearch/getCameraCodeList.do", "", function(result, data){
	...
	function getResolutionList(){	
		...
		ajaxCallJson("/airLibListSearch/getResolutionList.do", data, function(result, data){
...
**/
	...
	function getAirProductListPaging(){
		...
		setPagingInfo("mainDiv", "getAirProductListPaging", "/airLibListSearch/getAirProductList.do");
		ajaxCallJson("/airLibListSearch/getAirProductList.do", data, function(result, data){
			if (result.list != null){
	...
	function airProductView(zoneCode, phCourse, phNum){
		...
		ajaxCallPop("/airLibListSearch/airListSrchDetail.do", data, "", "");
	}
