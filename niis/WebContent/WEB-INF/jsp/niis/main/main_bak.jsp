...
<body onload="init();">
	...
	<div id="wrap">
		...
		<div id="header">
			...
			<a href="#main" id="btnMain" class="pageMove"><img src="/niis/images/common/h1_logo.png" style="margin-left:10px;" alt="공간정보 행정망 서비스" title="공간정보 행정망 서비스" /></a></h1>
			...
			<ul class="gnb">
				...
				<li class="menu_2">
					...
					<ul>
						...
						<li><a href="#mainDiv" class="pageMove" style="display:none" menuId="/airListSearch/listSearch.do">- 항공사진</a></li>
						<li><a href="#mainDiv" class="pageMove" style="display:none" menuId="/airLibListSearch/listSearch.do">- 항공사진(해방전후)</a></li>
										...
										<tr>
											...
											<td>
												<ul id="imgView" class="sortToggle">
													<li style="width:0px;display:none">항공사진</li>
													<li class="active" style="width:119px;">정사영상</li>
													<li class="last" style="width:119px;">수치표고</li>
												</ul>
											</td>
										</tr>
										<tr>
